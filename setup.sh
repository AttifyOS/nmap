...
install() {
  wget https://github.com/AttifyOS/nmap/releases/download/v7.92/nmap_7.92_amd64.snap -O $APM_TMP_DIR/nmap_7.92_amd64.snap
  sudo snap install $APM_TMP_DIR/nmap_7.92_amd64.snap --devmode
  sudo snap connect nmap:network-control
  rm $APM_TMP_DIR/nmap_7.92_amd64.snap
  echo "==============================="
